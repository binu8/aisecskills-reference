...
- When you need to analyze threat actor ttps with mitre attack
- When enriching threat intelligence or investigating threat actors and need a structured, step-by-step procedure
- Activates for requests involving: threat-intelligence, cti, ioc, mitre-attack
